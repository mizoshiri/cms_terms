...
#         post :create, {:page => { "type_id" => "invalid value" }}, valid_session
#         assigns(:page).should be_a_new(Page)
#       end
...
#         Page.any_instance.should_receive(:update).with({ "type_id" => "1" })
#         put :update, {:id => page.to_param, :page => { "type_id" => "1" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         Page.any_instance.stub(:save).and_return(false)
#         put :update, {:id => page.to_param, :page => { "type_id" => "invalid value" }}, valid_session
#         assigns(:page).should eq(page)
#       end
